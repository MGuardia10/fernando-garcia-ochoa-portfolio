...
export const NextButton = ({ projectName }) => {
  ...
  return (
    <Link
      ...
      className='bg-gray-100 hover:bg-gray-200 text-gray-900 dark:text-white dark:bg-[#292C2F] dark:hover:bg-[#4d5052] text-sm md:text-base duration-200 rounded-sm px-6 py-3 md:-mr-3 font-lato inline-flex items-center'
    >
      <span>{t('next')}</span>
