...
export const AboutMe = () => {
  return (
    <section className='my-15 md:py-20 bg-slate-50 dark:bg-[#171818]'>
      <h2 className='w-5/6 m-auto font-BASKVILL text-left text-2xl uppercase my-10 md:w-11/12 md:text-4xl xl:text-5xl dark:text-white'>Sobre Mi</h2>
      <div className='flex flex-col m-auto mb-8 w-5/6 md:w-full md:flex-row md: md:justify-center md:place-items-center md:gap-x-5'>
        ...
        <div className='md:w-1/2'>
          <div className='md:w-5/6 md:m-auto xl:w-4/6'>
            <h3 className='font-serif text-left text-xl uppercase xl:text-2xl dark:text-white'>¿Quién soy?</h3>
            ...
            <p className='mt-2 font-lato text-lg dark:text-gray-400'>Destaco mi versatilidad a la hora de afrontar nuevos retos y rápido aprendizaje.</p>
            <CVButton />
          </div>
