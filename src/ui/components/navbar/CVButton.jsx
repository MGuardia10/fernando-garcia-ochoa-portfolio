...
export const CVButton = () => {
  ...
  return (
    ...
    <a
      href={CVfernando}
      target='_blank'
      className='bg-gray-100 hover:bg-gray-200 text-gray-900 dark:text-white dark:bg-[#292C2F] dark:hover:bg-[#4d5052] text-sm md:text-base duration-200 rounded-sm px-3 py-2.5 font-lato inline-flex items-center'
      rel='noreferrer'
    >
